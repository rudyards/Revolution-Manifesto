...
describe "Any queries" do
  ...
  context "rarity" do
    ...
    # Rare-B-Gone Oracle text mentions "mythic"
    it do
      assert_search_equal %[any:"mythic"], %[r:"mythic" or ft:"mythic" or o:"mythic" or "Mythic Proportions"]
    end
    it "aliases" do
      assert_search_equal %[any:"mythic"], %[r:"mythic" or o:"mythic"]
    end
    it "is case insensitive" do
  ...
  context "is:" do
    ...
    it "draft" do
      ...
      assert_search_equal "any:draft", "is:draft or draft or (o:draft e:ymid,yneo,ysnc,hbg,ydmu,ybro,yone,ylci,ymkm,yblb,ydsk,unk,ydft)"
    end
  end
end
